...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  READY_TO_JOIN: { label: 'Ready To Join', className: 'badge-shortlisted' },
  JOINED: { label: 'Joined', className: 'badge-active' },
  TERMINATED: { label: 'Terminated', className: 'badge-rejected' },
  INTERNSHIP_COMPLETED: { label: 'Internship Completed', className: 'badge-completed' },
